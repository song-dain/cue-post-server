...
exports.HttpClient = exports.RETRYABLE_AXIOS_ERROR_CODES = void 0;
 ...
 * @internal
 */
exports.RETRYABLE_AXIOS_ERROR_CODES = new Set([
    'ETIMEDOUT',
    'ECONNABORTED',
    'ECONNRESET',
    'EPIPE',
...
class HttpClient {
    ...
    static async sendAxiosRequest(axiosRequestConfig) {
        try {
            ...
            if (axiosError.code !== undefined && exports.RETRYABLE_AXIOS_ERROR_CODES.has(axiosError.code)) {
