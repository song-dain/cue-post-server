...
class DocumentMinifier {
    ...
    deminifyDocument(inputFilePath, outputFilePath, cleanup = false) {
        ...
        try {
            ...
            throw new errors_1.DocumentDeminificationError(`Error when deminifying images. Error: ${error}`);
        }
        try {
    ...
    static createTemporaryDirectory() {
        const tempDir = path.join(os.tmpdir(), 'document_minification_' + (0, crypto_1.randomUUID)());
